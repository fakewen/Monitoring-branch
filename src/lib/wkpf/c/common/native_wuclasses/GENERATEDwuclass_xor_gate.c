          ...
          extern void wuclass_xor_gate_setup(wuobject_t *wuobject);
          extern void wuclass_xor_gate_update(wuobject_t *wuobject);

          
          wuclass_t wuclass_xor_gate = {
            WKPF_WUCLASS_XOR_GATE,
            wuclass_xor_gate_setup,
            wuclass_xor_gate_update,
            3,
            sizeof(bool),
...
WKPF_PROPERTY_TYPE_BOOLEAN+WKPF_PROPERTY_ACCESS_READONLY
              ...
              bool *wuclass_xor_gate_getPrivateData(wuobject_t *wuobject) {
