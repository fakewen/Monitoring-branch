...
class Monitoring_Planar(tornado.web.RequestHandler):
  def get(self):
      ...
      obj1 = Test('Light Sensor',3,2,'Room')#location tree
      obj2 = Test('Light Sensor',3,2,'Room')#location tree
      obj3 = Test('Light Sensor',3,2,'Room')#location tree
      obj4 = Test('Light Sensor',3,2,'Room')#location tree
      self.render('templates/index5.html', applications=[obj1,obj2,obj3,obj4])
